...
#define RX_PIN_NUMBER  7//16    // UART RX pin number.
#define TX_PIN_NUMBER  8//17    // UART TX pin number.
#define CTS_PIN_NUMBER 9//18    // UART Clear To Send pin number. Not used if HWFC is set to false.
#define RTS_PIN_NUMBER  10//19    // UART Request To Send pin number. Not used if HWFC is set to false.
#define HWFC           false // UART hardware flow control.

#define BUTTON_PULL    NRF_GPIO_PIN_PULLUP
#define WAKEUP_BUTTON_PIN               16//29                                    /**< Button used to wake up the application. */

#define ADVERTISING_LED_PIN_NO          1//LED_0                                       /**< LED to indicate advertising state. */
#define CONNECTED_LED_PIN_NO            30//LED_1                                       /**< LED to indicate connected state. */

#define DEVICE_NAME                     "nRFDuino"                               /**< Name of device. Will be included in the advertising data. */
#define LED_CC_DELAY_CONNECTED			4096
#define LED_CC_DELAY_NOT_CONNECTED		16384
...
#define START_STRING                    "Start nRFDuino...\r\n"                                /**< The string that will be sent over the UART when the application starts. */
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            ...
            //nrf_gpio_pin_clear(ADVERTISING_LED_PIN_NO);
						NRF_TIMER2->CC[0] = LED_CC_DELAY_CONNECTED;
        ...
        case BLE_GAP_EVT_DISCONNECTED:
            //nrf_gpio_pin_clear(CONNECTED_LED_PIN_NO);
						NRF_TIMER2->CC[0] = LED_CC_DELAY_NOT_CONNECTED;
...
*/
    ...
    NRF_TIMER2->PRESCALER   = 8;  //16Mhz/2^8 =
		/*
		 * Using a short between the COMPARE event and the CLEAR task is that
		 * the interrupt will occur with a steady frequency, although the handler may have some jitter do to other interrupts
		 */
	...
	NRF_TIMER2->TASKS_START = 1; //Timer start
...
//   uint32_t err_code;
    ...
    {	
				NRF_TIMER2->EVENTS_COMPARE[0] = 0;  //important to complete timer compare event
				nrf_gpio_pin_toggle(CONNECTED_LED_PIN_NO);
				//NRF_TIMER2->CC[0] += LED_CC_DELAY_NOT_CONNECTED;			//updates new CC[] value or use short cut register
    }
