...
#define TARGET_DEV_NAME                  "nRFDuino"                                    /**< Target device name that application is looking for. */
...
// simon   nrf_gpio_pin_set(ASSERT_LED_PIN_NO);
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_TIMEOUT:
            ...
            break;
        default:
					//printf("[on_ble_evt] unexpected msg 0x%x \r\n",p_ble_evt->header.evt_id);
            break;
    }
}
...
static void device_manager_init(void)
{
    ...
    // Clear all bonded devices if user requests to.   //simon MULTILINK_PERIPHERAL_BASE_UUID 
